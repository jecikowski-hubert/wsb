        ...
        <div id="content-wrap">
			...
			<?php
                ...
                if(isset($_GET['do']) && $_GET['do']==2) 
                {
                    ...
                    $prz = $polaczenie->query("SELECT * FROM przedmiot WHERE id_przedmiot = $id_przedmiot");
                    while($p = $prz->fetch_assoc()) 
                    {
                ?>
                <form action = "cards_backend.php" class = "form-horizontal" method="POST">
                    <input type = "hidden" name = "do" value = "2">
                    <input type = "hidden" name = "id_przedmiot" value = "<?php echo $id_przedmiot; ?>">
                    <input type = "text" name = "skrot" class = "form-control" value = "<?php echo $p['skrot'] ?>"> <br>
                    <input type = "text" name = "pelna" class = "form-control" value = "<?php echo $p['pelna'] ?>"> <br>
                <center>
                    <input type = "reset" class = "btn btn-default" value = "Wyczyść">
                ...
                <form action = "cards_backend.php" class = "form-horizontal" method="POST">
                    ...
                    <input type = "hidden" name = "id_przedmiot" value = "<?php echo $id_przedmiot; ?>">
                    <input type = "submit" class = "btn btn-danger" value = "Potwierdź usunięcie przedmiotu">
                </form>
                <?php
                    }
                }
